...
* **لو شغال بـ Android Emulator:** استخدم `http://10.0.2.2:3000/api` للاتصال بالـ Backend.
* **لو شغال بجهاز حقيقي:** استخدم الـ IP الخاص بجهازك (مثال: `http://192.168.1.5:3000/api`) بشرط أن يكون اللابتوب والموبايل على نفس شبكة الـ Wi-Fi.
